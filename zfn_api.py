...
class Client:
    ...
    def login(self, sid, password):
        ...
        try:
            ...
            # print(f"Requesting {self.login_url}")
            # print(req_csrf.text)
            ...
            print(f"Requesting {self.key_url}")
            print(req_pubkey)
            ...
            if str(doc("input#yzm")) == "":
                ...
                print(f"Requesting {self.login_url} with data: {login_data}")
...
if __name__ == "__main__":
    ...
    base_url = "https://zhjw1.jju.edu.cn/jwglxt/"  # 教务系统URL
    sid = "20230204994"  # 学号
    password = "S121477cj@"  # 密码
    lgn_cookies = (
        {
            # "insert_cookie": "",
            # "route": "",
